    ...
    return (
      <section className="bg-gray-900 border border-blue-400 border-opacity-50 pb-10 pt-10">
        <div className="container px-6 py-10 mx-auto">
          <motion.h1
            className="text-blue-400 capitalize font-extrabold text-8xl mb-16 mt-16 text-center"
          ...
          <motion.p
            className="mt-4 text-gray-300 xl:mt-6 text-center"
            initial={{ opacity: 0, y: 50 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
            {/* Bootcamp 1 */}
            <motion.div
              className="p-8 space-y-3 border-2 border-blue-300 rounded-xl transform transition-transform duration-300 hover:scale-105 hover:shadow-lg hover:shadow-blue-500/50"
